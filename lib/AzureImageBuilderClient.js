                    ...
                    if ( this._taskParameters.actionRunMode != "full" && templateName && subscriptionId ){
                        ...
                        if ( this._taskParameters.actionRunMode == "custom" ){
                            try {
                                ...
                                console.log(this._taskParameters.actionStartTime);
                                console.log(this._taskParameters.actionStartTime.getTime());
                                console.log(this._taskParameters.actionStartTime.getTime());
                                console.log(((current_time.getTime() - this._taskParameters.actionStartTime.getTime()) / 1000 / 60));
                                console.log(Math.floor((current_time.getTime() - this._taskParameters.actionStartTime.getTime()) / 1000 / 60));
                                running_time_minutes = Math.floor((current_time.getTime() - this._taskParameters.actionStartTime.getTime()) / 1000 / 60);
