...
class ImageBuilderClient {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (response.statusCode == 201) {
                    response = yield this.getLongRunningOperationResult("putImageTemplate", response);
                }
                if (response.statusCode != 200 || response.body.status == "Failed") {
                    throw AzureRestClient_1.ToError(response);
                }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (response.statusCode == 202) {
                    response = yield this.getLongRunningOperationResult('getRunTemplate', response);
                }
                if (response.statusCode != 200 || response.body.status == "Failed") {
                    throw AzureRestClient_1.ToError(response);
                }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (response.statusCode == 202) {
                    ...
                    response = yield this.getLongRunningOperationResult('runTemplate', response, timeOutInMinutes, templateName, subscriptionId);
                }
                if (response.statusCode != 200 || response.body.status == "Failed") {
                    throw AzureRestClient_1.ToError(response);
                }
    ...
    deleteTemplate(templateName, subscriptionId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                var response = yield this._client.beginRequest(httpRequest);
                if (response.statusCode == 202) {
                    response = yield this.getLongRunningOperationResult('deleteTemplate', response);
                }
                if (response.statusCode != 200 || response.body.status == "Failed") {
                    throw AzureRestClient_1.ToError(response);
                }
    ...
    getLongRunningOperationResult(action, response, timeoutInMinutes, templateName, subscriptionId) {
        var response;
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (true) {
                ...
                if (response.statusCode === 202 || (response.body && (response.body.status == "Accepted" || response.body.status == "Running" || response.body.status == "InProgress"))) {
                    ...
                    if ( action == "runTemplate" && this._taskParameters.actionRunMode != "full" && templateName && subscriptionId ){
